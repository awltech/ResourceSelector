...
public class Activator extends AbstractUIPlugin {
	...
	private boolean isImageRegistryUsed = false;

	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipselabs.resourceselector.ext.primitives";
